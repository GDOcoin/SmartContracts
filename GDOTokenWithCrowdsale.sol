...
// ----------------------------------------------------------------------------
// 'GDO Token' contract with Crowdsale functionality and ERC20 compliance
//
...
// Decimals    : 18
//
// Copyright (c) 2018 GDO Infotech Pvt Ltd (www.GDO.co.in)  
// ----------------------------------------------------------------------------
    ...
    contract GDOTokenWithCrowdsale is owned, TokenERC20 {
    	using SafeMath for uint256;
    	
    	/********************************/
      /* Code for the ERC20 GDO Token */
      /********************************/
    
    	// Public variables of the token
    	string private tokenName = "GDO Token";
      string private tokenSymbol = "GDO";
      uint256 private initialSupply = 50000000000; 	// Initial supply of the tokens   
